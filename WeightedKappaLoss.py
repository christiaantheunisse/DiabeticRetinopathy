...
"""
    Copied from https://gist.github.com/SupreethRao99/2e85884dad433a6b381f966fea7a6658#file-weightedkappaloss-py
    Verified it with sklearn.metrics.cohen_kappa_score
    Verified it with print statements with https://www.kaggle.com/code/reighns/understanding-the-quadratic-weighted-kappa
"""
  ...
  def __init__(
    ...
    """Creates a `WeightedKappaLoss` instance.
        Args:
          ...
          mode: (Optional) Weighting to be considered for calculating
            kappa statistics. A valid value is one of
            ['linear', 'quadratic']. Defaults to 'quadratic'.
          validate: When true, returns the kappa score (\kappa) instead of the kappa loss ln(1 - \kappa)
